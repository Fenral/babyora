...
type Props = Readonly<{ snapshot: OutfitTruthSnapshotV1; selectedId: OutfitItemId | null; highlightedId: OutfitItemId | null; captionId: string; registerOutfitRow?: RegisterOutfitRow; onActivate: (id: OutfitItemId) => void; onFocus: (id: OutfitItemId | null) => void; onHover: (id: OutfitItemId | null) => void; onAlternative: (id: OutfitItemId) => void; hasAlternative: (id: OutfitItemId) => boolean; }>;
