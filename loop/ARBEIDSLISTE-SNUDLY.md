...
| SN-W02 | Rett DoD-regel C2 til å verne de faktisk provisjonerte produkt-IDene, og før eiervedtaket om betaling inn i `docs/DECISION-LOG.md`. C1 (bundle-id) står urørt. Per vedtakets V6 | E | — | FERDIG |
...
| ID | Oppgave | Type | Avh. | Status |
| --- | --- | --- | --- | --- |
| SN-030 | RevenueCat-nøkler og `VITE_FORECAST_PROXY` inn i native byggekonfigurasjon (kun konfig, ingen konsoll) | C | SN-002 | EIER |
