...
| SN-W02 | Rett DoD-regel C2 til å verne de faktisk provisjonerte produkt-IDene, og før eiervedtaket om betaling inn i `docs/DECISION-LOG.md`. C1 (bundle-id) står urørt. Per vedtakets V6 | E | — | TIL KONTROLL |
