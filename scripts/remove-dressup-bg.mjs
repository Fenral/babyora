#!/usr/bin/env node
/* Chroma-key magenta → transparent for dressup plagg PNGs.
 *
 * Same algorithm as remove-avatar-bg.mjs but targets
 * public/illustrations/dressup/ and is calibrated for the magenta
 * background used by generate-dressup-plagg.mjs (#FF00FF).
 */
...
const DIR = "public/illustrations/dressup";
