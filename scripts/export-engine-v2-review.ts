...
import { recommendV2 } from '../src/lib/clothing-engine-v2/recommend.js';
import { compareShadow } from '../src/lib/clothing-engine-v2/shadow-compare.js';
import { EngineV2Error } from '../src/lib/clothing-engine-v2/errors.js';
import { GOLD_SCENARIOS } from '../src/lib/clothing-engine-v2/__tests__/gold-scenarios.js';
import { recommend } from '../src/lib/wool-layers/recommend.js';
import type { RecommendInputV2, Situation } from '../src/lib/clothing-engine-v2/types.js';
...
// Kjør som script (tsx scripts/export-engine-v2-review.ts)
