...
- [Phase 1]: The effective 2026-07-19 owner decision locks Planlegg to one continuous semantic Dagslinje; superseded variants are history only.
- [Phase 1]: Current owner authorization is locked for this bounded initialization/planning scope; app-code execution still requires the reviewed contract to remain unchanged.
...
- [Phase 01]: Plan 01-05: Resolver accepts the locked ReadonlyMap contract and uses Map intrinsics so Proxy-wrapped maps fail closed.
...
|----------|------|--------|-------------|
| Evidence | New app screenshots/video and final media-based 90+ visual gate | Pending stable candidate and owner permission | Initialization |
| Release | Final physical-device evidence and owner release approval | Pending final gate | Initialization |
