...
- [x] `01-02-PLAN.md` — Wave 1 forecast provenance/currentness/coverage and atomic weather-hook behavior (high risk; repaired candidate awaiting fresh independent review)
