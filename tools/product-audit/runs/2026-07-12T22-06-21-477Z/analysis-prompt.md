...
- guide (Guide, appvekt 7%): Organisere verktøy og kunnskap uten å skjule den daglige hovedoppgaven.
- find-outfit (Finn antrekk, appvekt 6%): La forelderen utforske vær og situasjon med tydelig årsak–virkning.
- clothing-library (Plaggbibliotek, appvekt 3%): Gi et lavfriksjons oppslagsverk som bygger forståelse og tillit.
- wardrobe (Min garderobe, appvekt 3%): Vise om registreringsarbeidet gir nok personlig verdi til å forsvares.
...
- settings (Innstillinger, appvekt 5%): Gjøre barn, sted, varsler, personvern og abonnement forståelig og kontrollerbart.
...
## Skjermbilder
- onboarding/start: CAPTURE_FAILED (failed)
- home/default: CAPTURE_FAILED (failed)
- outfit/recommendation: CAPTURE_FAILED (failed)
- plan/default: CAPTURE_FAILED (failed)
- guide/hub: CAPTURE_FAILED (failed)
- find-outfit/default: CAPTURE_FAILED (failed)
- clothing-library/overview: CAPTURE_FAILED (failed)
- wardrobe/default: CAPTURE_FAILED (failed)
- tog/default: CAPTURE_FAILED (failed)
- warm-cold/default: CAPTURE_FAILED (failed)
- first-winter/overview: CAPTURE_FAILED (failed)
- settings/default: CAPTURE_FAILED (failed)
- paywall/default: CAPTURE_FAILED (failed)
