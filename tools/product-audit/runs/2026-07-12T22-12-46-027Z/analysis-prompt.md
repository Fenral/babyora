...
- outfit/recommendation: screenshots/outfit--recommendation.png (captured)
- plan/default: screenshots/plan--default.png (captured)
- guide/hub: screenshots/guide--hub.png (captured)
- find-outfit/default: screenshots/find-outfit--default.png (captured)
- clothing-library/overview: screenshots/clothing-library--overview.png (captured)
- wardrobe/default: screenshots/wardrobe--default.png (captured)
