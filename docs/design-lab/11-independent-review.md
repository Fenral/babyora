...
| P0-2 Føles-som-inkonsistens Hjem vs Juster | **AKSEPTERT.** Teknisk riktig og alvorlig. Fiks = én normalisert værkontrakt for alle flater. Implementeres som egen liten pakke KOORDINERT med skjermløypa (Juster-flaten var under aktiv endring i dag); logget som teknisk P0-oppgave med Claude som eier | Åpen → neste tekniske pakke |
