...
| Av fase 3-kohorten: fortsatt umigrert | **8** |
...
|---|---|---:|---|---:|---:|---|---|---|
| Familie (skall) | `src/screens/FamilieScreen.tsx` | 98 | `FamilieScreen.css` | 56 | 22 | App.tsx lazy()-register | nei | — |
| Finn antrekk / Juster | `src/screens/FinnAntrekkScreen.tsx` | 1499 | 20 CSSProperties + 4 `style={{` | 59 | 0 | App.tsx lazy()-register | ja | 3 |
| Hjem (referanse) | `src/screens/HjemScreen.tsx` | 1329 | 1 `<style>` + 23 CSSProperties + 6 `style={{` | 11 | 22 | App.tsx lazy()-register | ja | 3 |
| Innstillinger | `src/screens/InnstillingerScreen.tsx` | 6417 | 190 CSSProperties + 50 `style={{` | 336 | 5 | rendres av FamilieScreen.tsx | ja | 3 |
| Onboarding | `src/screens/OnboardingScreen.tsx` | 1894 | 1 CSSProperties | 220 | 34 | App.tsx lazy()-register | ja | 3 |
| Påkledning | `src/screens/PaakledningScreen.tsx` | 629 | — | 0 | 0 | App.tsx lazy()-register | nei | 4 |
...
| Verktøy | `src/screens/VerktoyScreen.tsx` | 75 | `VerktoyScreen.css` | 28 | 13 | App.tsx lazy()-register | ja | 3 |
...
|---|---|
| Familie (skall) | umigrert (22 legacy-token, 0 rå hex, 56 `--dw-*`) |
...
| Verktøy | umigrert (13 legacy-token, 0 rå hex, 28 `--dw-*`) |
...
Ansvarlig fase: **—**. Familie-skallet er erstattet av den eiergodkjente Snudly-flaten og bruker Snudly-designsystemet direkte. Den gamle fase 3-tokenmigreringen gjelder fortsatt InnstillingerScreen som aapnes herfra, ikke det nye skallet.
...
- `routeKey`-tildelinger: 9 — `drill:finn-antrekk`, `drill:plaggbib`, `drill:familie-tool:tog`, `drill:familie-tool:varm-kald`, `drill:familie-tool:forste-vinter`, `tab:hjem`, `tab:plan`, `tab:verktoy`, `tab:familie`
