...
Motor 2.0 adds the free per-child `materialPreference`; the server column defaults to `best_for_conditions`, validates the three allowed values, and follows normal child-edit role permissions.
