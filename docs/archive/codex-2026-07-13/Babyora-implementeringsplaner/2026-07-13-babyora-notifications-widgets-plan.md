...
**Architecture:** A pure significance engine compares canonical Motor 2.0 fingerprints and emits actions, not raw weather alerts. Semantic work waits for the V2 fingerprint and explanation codes to stabilize.
